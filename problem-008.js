...
const productOfAdjacentDigits = (digits) => {
  let product = 1;
...
const largestProductInSeries = (num, numOfDigits) => {
  let maxProduct = -Infinity;
  for (let i = 0; i < num.length - numOfDigits; i++) {
    const product = productOfAdjacentDigits(num.slice(i, i + numOfDigits));
